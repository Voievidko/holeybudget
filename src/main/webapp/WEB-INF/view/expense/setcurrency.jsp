        ...
        <div class="container-fluid">
          ...
          <div class="p-1">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-4">Set currency</h1>
            </div>


            <form:form action="currencyProcess" modelAttribute="expense">
            <div class="form-group">
              Your expense is ${expense.sum} ${expense.currency.code} set corresponding sum in ${expense.account.currency.code}
            </div>
            <div class="form-group">
              ...
              <input type="hidden" name="expenseComment" value="${expense.comment}" />
              <input type="hidden" name="expenseCategory" value="${expense.category.categoryId}" />
              <input type="hidden" name="expenseAccount" value="${expense.account.accountId}" />
              <input type="hidden" name="expenseCurrency" value="${expense.currency.code}" />
