      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="p-1">
            ...
            <form:form action="currencyProcess" modelAttribute="account">
            <div class="form-group">
              Your account ${accountFrom.type} is in ${accountFrom.currency.code}.<br>
              Set corresponding value for ${sum} ${accountFrom.currency.code} in target account ${accountTo.type} in ${accountTo.currency.code}
            </div>
            <div class="form-group">
