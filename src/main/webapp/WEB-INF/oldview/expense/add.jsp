        ...
        <form:form action="addProcess" modelAttribute="expense">
            <table>
                ...
                <tr>
                    ...
                    <td><form:input path="sum"/> <form:errors path="sum" cssClass="card mb-4 py-3 border-left-danger"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <form:input type="date" path="date" pattern="dd/MM/yyyy" cssClass="date"/>
